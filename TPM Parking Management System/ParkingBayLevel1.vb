...
Public Class ParkingBayLevel1
    ...
    Private Sub ParkingBayLevel1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        spc.SpeakAsync("Welcome to the Parking Bay Level 1! Please insert the information in the text box below!")
        lblICNumber.Text = h
        ...
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-01'"
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-02'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-03'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-04'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-05'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-06'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-07'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-08'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-09'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-10'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-11'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-12'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-13'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-14'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-15'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-16'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-17'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-18'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-19'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-20'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-21'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-22'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-23'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-24'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-25'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-26'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-27'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-28'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-29'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-30'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-31'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-32'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-33'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-34'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-35'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-36'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-37'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-38'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-39'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-40'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-41'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-42'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-43'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-44'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-45'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-46'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-47'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-48'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-49'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv1-50'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
    ...
    Private Sub txtParkingSpaceID_TextChanged(sender As Object, e As EventArgs) Handles txtParkingSpaceID.TextChanged

    End Sub

    Private Sub txtDepositPaid_TextChanged(sender As Object, e As EventArgs) Handles txtDepositPaid.TextChanged
    ...
    Private Sub lblICNumber_Click(sender As Object, e As EventArgs) Handles lblICNumber.Click
