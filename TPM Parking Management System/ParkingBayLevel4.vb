...
Public Class ParkingBayLevel4
    ...
    Private Sub ParkingBayLevel4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-01'"
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-02'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-03'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-04'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-05'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-06'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-07'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-08'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-09'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-10'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-11'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-12'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-13'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-14'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-15'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-16'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-17'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-18'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-19'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-20'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-21'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-22'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-23'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-24'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-25'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-26'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-27'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-28'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-29'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-30'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-31'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-32'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-33'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-34'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-35'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-36'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-37'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-38'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-39'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-40'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-41'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-42'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-43'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-44'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-45'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-46'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-47'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-48'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-49'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
        ...
        conn = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=VB.Net Assignment.accdb;Persist Security Info=False;")
        conn.Open()
        sql = "SELECT Status FROM ParkingBay WHERE ParkingSpaceID='Lv4-50'"
        cmd = New OleDbCommand(sql, conn)
        ABC = cmd.ExecuteReader
        ABC.Read()
        a = ABC.Item("Status")
